...
public class WxMpConfiguration {
     ...
     * @return
     */
    public static WxMpService getWxMpService(String wechatName) {

        WxMpService wxMpService = mpServices.get(ShopKeyUtils.getYshopWeiXinMpSevice(wechatName));
        //增加一个redis标识
        if(wxMpService == null || RedisUtil.get(ShopKeyUtils.getYshopWeiXinMpSevice(wechatName)) == null) {
            WxMpDefaultConfigImpl configStorage = new WxMpDefaultConfigImpl();
            configStorage.setAppId(RedisUtil.get(ShopKeyUtils.getWechatAppId(wechatName)));
            configStorage.setSecret(RedisUtil.get(ShopKeyUtils.getWechatAppSecret(wechatName)));
            configStorage.setToken(RedisUtil.get(ShopKeyUtils.getWechatToken(wechatName)));
            configStorage.setAesKey(RedisUtil.get(ShopKeyUtils.getWechatEncodingAESKey(wechatName)));
            wxMpService = new WxMpServiceImpl();
            wxMpService.setWxMpConfigStorage(configStorage);
            mpServices.put(ShopKeyUtils.getYshopWeiXinMpSevice(wechatName), wxMpService);
            routers.put(ShopKeyUtils.getYshopWeiXinMpSevice(wechatName), newRouter(wxMpService));

            //增加标识
            RedisUtil.set(ShopKeyUtils.getYshopWeiXinMpSevice(wechatName),"yshop");
        }
        return wxMpService;
    }
     ...
     * 移除WxMpService
     */
    public static void removeWxMpService(String wechatName){
        RedisUtil.del(ShopKeyUtils.getYshopWeiXinMpSevice(wechatName));
        mpServices.remove(ShopKeyUtils.getYshopWeiXinMpSevice(wechatName));
        routers.remove(ShopKeyUtils.getYshopWeiXinMpSevice(wechatName));
    }

    /**
     *  获取WxMpMessageRouter
     */
    public static WxMpMessageRouter getWxMpMessageRouter(String wechatName) {
        WxMpMessageRouter wxMpMessageRouter = routers.get(ShopKeyUtils.getYshopWeiXinMpSevice(wechatName));
