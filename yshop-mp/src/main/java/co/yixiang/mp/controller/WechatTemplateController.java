...
public class WechatTemplateController {
    ...
    @GetMapping(value = "/minApp")
    @ApiOperation("查询微信小程序模板消息")
    @AnonymousAccess
    public ApiResult<Object> getMinAppTemplates(YxWechatTemplateQueryCriteria criteria, Pageable pageable){
        return ApiResult.ok(yxWechatTemplateService.queryAll(criteria,pageable));
    }
}
