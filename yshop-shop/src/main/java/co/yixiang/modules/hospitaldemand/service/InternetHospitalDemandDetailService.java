...
/**
    ...
    */
    Map<String,Object> queryAll(InternetHospitalDemandDetailQueryCriteria criteria, Pageable pageable);

    /**
    * 查询所有数据不分页
    * @param criteria 条件参数
    * @return List<InternetHospitalDemandDetailDto>
    */
    List<InternetHospitalDemandDetail> queryAll(InternetHospitalDemandDetailQueryCriteria criteria);
    ...
    * @throws IOException /
    */
    void download(List<InternetHospitalDemandDetailDto> all, HttpServletResponse response) throws IOException;
}
