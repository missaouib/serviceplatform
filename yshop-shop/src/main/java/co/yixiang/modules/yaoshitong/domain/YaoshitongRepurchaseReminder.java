...
*/
@Data
@TableName("yaoshitong_repurchase_reminder")
public class YaoshitongRepurchaseReminder implements Serializable {
    ...
    public void copy(YaoshitongRepurchaseReminder source){
