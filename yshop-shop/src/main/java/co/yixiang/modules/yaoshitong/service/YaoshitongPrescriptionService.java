...
/**
    ...
    */
    Map<String,Object> queryAll(YaoshitongPrescriptionQueryCriteria criteria, Pageable pageable);

    /**
    * 查询所有数据不分页
    * @param criteria 条件参数
    * @return List<YaoshitongPrescriptionDto>
    */
    List<YaoshitongPrescription> queryAll(YaoshitongPrescriptionQueryCriteria criteria);
    ...
    * @throws IOException /
    */
    void download(List<YaoshitongPrescriptionDto> all, HttpServletResponse response) throws IOException;
}
