...
/**
    ...
    */
    Map<String,Object> queryAll(YaoshitongRepurchaseReminderQueryCriteria criteria, Pageable pageable);

    /**
    * 查询所有数据不分页
    * @param criteria 条件参数
    * @return List<YaoshitongRepurchaseReminderDto>
    */
    List<YaoshitongRepurchaseReminder> queryAll(YaoshitongRepurchaseReminderQueryCriteria criteria);
    ...
    * @throws IOException /
    */
    void download(List<YaoshitongRepurchaseReminderDto> all, HttpServletResponse response) throws IOException;

    Boolean generateReminder();

    Boolean medCycleNotice();
}
