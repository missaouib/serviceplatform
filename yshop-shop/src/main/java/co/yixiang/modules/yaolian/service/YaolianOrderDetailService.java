...
/**
    ...
    */
    Map<String,Object> queryAll(YaolianOrderDetailQueryCriteria criteria, Pageable pageable);

    /**
    * 查询所有数据不分页
    * @param criteria 条件参数
    * @return List<YaolianOrderDetailDto>
    */
    List<YaolianOrderDetail> queryAll(YaolianOrderDetailQueryCriteria criteria);
    ...
    * @throws IOException /
    */
    void download(List<YaolianOrderDetailDto> all, HttpServletResponse response) throws IOException;
}
