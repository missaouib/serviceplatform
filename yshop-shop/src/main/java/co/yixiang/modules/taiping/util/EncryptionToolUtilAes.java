...
/*
        ...
        logger.info("XSYF20120120000003={}",EncryptionToolUtilAes.encrypt("XSYF20120120000003", CipherKey));
        logger.info("wA722d6CceeP5G4PwkyBHmoXBPioI87Vcn/g+yxTWoU={}",EncryptionToolUtilAes.decrypt("wA722d6CceeP5G4PwkyBHmoXBPioI87Vcn/g+yxTWoU=", CipherKey));
        logger.info("加密前 realName:{}","李彩虹");
        logger.info("加密后 realName:{}",EncryptionToolUtilAes.encrypt("李彩虹", CipherKey));

        logger.info("加密前 certiType:{}","1");
        logger.info("加密后 certiType:{}",EncryptionToolUtilAes.encrypt("1", CipherKey));

        logger.info("加密前 certiNo:{}","610402197108230028");
        logger.info("加密后 certiNo:{}",EncryptionToolUtilAes.encrypt("610402197108230028", CipherKey));
...
//        对称加密
        ...
        logger.info(data);
//        对称解密
        String dataDEC = EncryptionToolUtilAes.decrypt(data, CipherKey);
        logger.info(dataDEC);
        ...
        */
        ...
        card.setCardNumber("XSYF21010928000001");
        card.setCardType("advanced");
        card.setAgentCate("1");
        card.setSellChannel("1");
        card.setOrganID("101");
        card.setInsertTime("2021-09-28 14:48:25");
        JSONObject jsonObject = JSONUtil.parseObj(card);
        String carddata = JSONUtil.toJsonStr(jsonObject);
        String cardDataEnc = EncryptionToolUtilAes.encrypt(carddata, CipherKey);
