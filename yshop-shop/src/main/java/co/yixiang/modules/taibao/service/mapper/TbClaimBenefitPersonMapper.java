...
@Repository
@Mapper
public interface TbClaimBenefitPersonMapper extends CoreMapper<TbClaimBenefitPerson> {
    public boolean deleteByMainId(@Param("mainId") Long mainId);

    public List<TbClaimBenefitPerson> selectByMainId(@Param("mainId") Long mainId);
