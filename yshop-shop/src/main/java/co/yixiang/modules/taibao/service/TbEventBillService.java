...
* @date 2021-04-30
*/
public interface TbEventBillService  extends BaseService<TbEventBill> {
...
/**
    ...
    */
    Map<String,Object> queryAll(TbEventBillQueryCriteria criteria, Pageable pageable);

    /**
    * 查询所有数据不分页
    * @param criteria 条件参数
    * @return List<TbEventBillDto>
    */
    List<TbEventBill> queryAll(TbEventBillQueryCriteria criteria);
    ...
    * @throws IOException /
    */
    void download(List<TbEventBillDto> all, HttpServletResponse response) throws IOException;
