...
@Repository
@Mapper
public interface TbClaimThirdInsuranceMapper extends CoreMapper<TbClaimThirdInsurance> {
    public boolean deleteByMainId(@Param("mainId") Long mainId);

    public List<TbClaimThirdInsurance> selectByMainId(@Param("mainId") Long mainId);
