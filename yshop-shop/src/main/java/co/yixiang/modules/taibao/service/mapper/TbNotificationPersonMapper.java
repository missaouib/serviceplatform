...
@Repository
@Mapper
public interface TbNotificationPersonMapper extends CoreMapper<TbNotificationPerson> {
    public boolean deleteByMainId(@Param("mainId") Long mainId);

    public List<TbNotificationPerson> selectByMainId(@Param("mainId") Long mainId);
