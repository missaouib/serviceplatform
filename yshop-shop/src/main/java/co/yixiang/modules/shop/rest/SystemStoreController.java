...
public class SystemStoreController {
    ...
    @PreAuthorize("@el.check('yxSystemStore:list','TBPOLICYINFO_ALL')")
    ...
    @Log("获取经纬度")
    @ApiOperation("获取经纬度")
    @PreAuthorize("@el.check('yxSystemStore:getl','TBPOLICYINFO_ALL')")
    ...
    @Log("新增门店")
    @ApiOperation("新增门店")
    @PreAuthorize("@el.check('yxSystemStore:add','TBPOLICYINFO_ALL')")
    ...
    @Log("修改门店")
    @ApiOperation("修改门店")
    @PreAuthorize("@el.check('yxSystemStore:edit','TBPOLICYINFO_ALL')")
    ...
    @Log("删除门店")
    @ApiOperation("删除门店")
    @PreAuthorize("@el.check('yxSystemStore:del','TBPOLICYINFO_ALL')")
    @DeleteMapping
