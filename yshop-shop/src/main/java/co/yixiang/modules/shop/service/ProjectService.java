...
/**
    ...
    */
    ...
    String generateQRCode(String projectNo,String staffCode);

    String generateQRCodeH5(String projectNo,String staffCode);

    boolean saveProject(Project resources);

    List<String> queryProjectCode(String userName);
}
