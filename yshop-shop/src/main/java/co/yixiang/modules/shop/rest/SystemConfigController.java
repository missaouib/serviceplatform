        ...
        jsonObject.forEach(
                (key,value)->{
                    ...
                    if(SystemConfigConstants.WECHAT_APPID.equals(key)){
                        WxMpConfiguration.removeWxMpService(WechatNameEnum.WECHAT.getValue());
                        WxPayConfiguration.removeWxPayService(WechatNameEnum.WECHAT.getValue());
                    }
                    if(SystemConfigConstants.WXPAY_MCHID.equals(key) || SystemConfigConstants.WXAPP_APPID.equals(key)){
                        WxPayConfiguration.removeWxPayService(WechatNameEnum.WECHAT.getValue());
                    }
                    if(SystemConfigConstants.WXPAY_MCHID_GUANGZHOU.equals(key) || SystemConfigConstants.WXAPP_APPID.equals(key)){
                        WxPayConfiguration.removeWxPayService(WechatNameEnum.GUANGZHOU.getValue());
                    }

                    //重新配置微信相关-- 药师通
                    if(SystemConfigConstants.WECHAT_APPID_YAOSHITONG.equals(key)){
                        WxMpConfiguration.removeWxMpService(WechatNameEnum.YIAOSHITONG.getValue());
                        WxPayConfiguration.removeWxPayService(WechatNameEnum.YIAOSHITONG.getValue());
                    }
                    if(SystemConfigConstants.WXPAY_MCHID_YAOSHITONG.equals(key) || SystemConfigConstants.WX_NATIVE_APP_APPID_YAOSHITONG.equals(key)){
                        WxPayConfiguration.removeWxPayService(WechatNameEnum.YIAOSHITONG.getValue());
                    }
