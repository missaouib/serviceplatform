...
public interface ShopConstants {
	...
	String YSHOP_WEIXIN_PAY_SERVICE_GUANGZHOU = "yshop_weixin_pay_service_guangzhou";

	String YSHOP_WEIXIN_PAY_SERVICE_YAOSHITONG = "yshop_weixin_pay_service_yaoshitong";
	...
	String YSHOP_WEIXIN_MP_SERVICE_YAOSHITONG = "yshop_weixin_mp_service_yaoshitong";
	 ...
	 * 商城默认注册图片
	 */
	String YSHOP_DEFAULT_AVATAR = "https://oms-imgs-sphcc.oss-cn-shanghai.aliyuncs.com/temp/head_1624415686582.png";
	...
	String YSHOP_HOME_FIND_DRUG_BANNER = "yshop_home_find_drug_banner";

	String YSHOP_HOME_BANNER_YAOSHITONG = "yshop_home_banner_live_yiyaotong";
	/**
	 * 首页菜单
	 */
	...
	/**内购价打折比率*/
	BigDecimal INNER_DISCOUNT_RATE = new BigDecimal("0.8");

	String STORENAME_GUANGZHOU_CLOUD = "广州上药益药药房有限公司（云药房）";

	String STORENAME_GUANGZHOU = "广州上药益药药房有限公司";

	String STORENAME_SHANGHAI_CLOUD = "上药云健康益药药房（上海）有限公司中山西路店";
}
