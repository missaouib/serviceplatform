...
public class CodeGenerator {
    ...
    private static final String USER_NAME = "wechattest";

    private static final String PASSWORD = "123456";
    private static final String DRIVER_NAME = "com.mysql.cj.jdbc.Driver";

    private static final String DRIVER_URL = "jdbc:mysql://10.80.28.93:3306/wechattest?autoReconnect=true&useUnicode=true&characterEncoding=utf8&serverTimezone=GMT%2B8";
    ...
    // 作者
    private static final String AUTHOR = "visa";
    // 生成的表名称
    private static final String TABLE_NAME = "yx_store_product_group";    // 主键数据库列名称
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir(projectPath + "/generateCode/src/main/java");
        gc.setAuthor(AUTHOR);
        ...
        focList.add(new FileOutConfig("/templates/mapper.xml.vm") {
            ...
            public String outputFile(TableInfo tableInfo) {
                // 自定义输入文件名称
                return projectPath + "/generateCode/src/main/resources/mapper/" + pc.getModuleName()
        ...
        focList.add(new FileOutConfig("/templates/queryParam.java.vm") {
            @Override
            public String outputFile(TableInfo tableInfo) {
                return projectPath + "/generateCode/src/main/java/"+ PROJECT_PACKAGE_PATH +"/modules/" + pc.getModuleName() + "/web/param/" + tableInfo.getEntityName() + "QueryParam" + StringPool.DOT_JAVA;
            }
        });
        ...
        focList.add(new FileOutConfig("/templates/queryVo.java.vm") {
            @Override
            public String outputFile(TableInfo tableInfo) {
                return projectPath + "/generateCode/src/main/java/"+ PROJECT_PACKAGE_PATH +"/modules/" + pc.getModuleName() + "/web/vo/" + tableInfo.getEntityName() + "QueryVo" + StringPool.DOT_JAVA;
            }
        });
