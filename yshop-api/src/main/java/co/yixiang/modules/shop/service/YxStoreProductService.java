...
public interface YxStoreProductService extends BaseService<YxStoreProduct> {
    ...
    YxStoreProductQueryVo goodsDetail4Store(int id,int type,int uid,String latitude,String longitude,String uniqueId,String projectCode,String cardNumber,String cardType,List<Integer> storeIds);
    List<YxStoreProductQueryVo> getGoodsList(YxStoreProductQueryParam productQueryParam);

    List<YxStoreProductQueryVo> getGoodsList4Store(YxStoreProductQueryParam productQueryParam);
