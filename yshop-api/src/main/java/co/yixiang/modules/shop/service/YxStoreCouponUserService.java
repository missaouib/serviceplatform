...
public interface YxStoreCouponUserService extends BaseService<YxStoreCouponUser> {
    ...
    int getUserValidCouponCount(int uid,String projectCode);

    void useCoupon(int id);

    void useCoupon(int id,double factDeductionAmount,Integer status);
    ...
    List<YxStoreCouponUserQueryVo > getUserCoupon(int uid,int type,String projectCode,String cardNumber);
    ...
    YxStoreCouponUser beUsableCoupon4project(int uid,double price,String projectCode,String cardType,String orderSource);

    double getTotalFactDeductionAmount(Integer uid);

    List<YxStoreCouponUser> beUsableCouponList4project(int uid,double price,String projectCode,String cardType,String orderSource,String orderKey);

    void updateCoupon(ZhongAnParamDto param,Integer uid);
}
