...
//    private String pwd;
   ...
   // @JsonIgnore
    ...
    @ApiModelProperty(value = "内部员工编号")
    private String innerEmployeeCode;

    @ApiModelProperty(value = "是否内部员工 0/否，1/是")
    private Integer isInner;
    @ApiModelProperty(value = "药师手机号，药师绑定")
    private String yaoshiPhone;

    @ApiModelProperty(value = "是否接受复购提醒")
    ...
    @ApiModelProperty(value = "微信小程序授权标识")
    private String wechatMiniAppAuthFlag;

    @ApiModelProperty(value = "微信公众号授权标识")
    private String wechatAuthFlag;

    @ApiModelProperty(value = "众安用户唯一码")
    private String zhonganCardNumber;
}