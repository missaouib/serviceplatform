    ...
    public Page<RedisVo> findByKey(String key, Pageable pageable){
        ...
        for (Object s : redisTemplate.keys(key)) {
            ...
            if (s.toString().indexOf("role::loadPermissionByUser") != -1
                    ...
                    || s.toString().indexOf(ShopKeyUtils.getSiteUrl(WechatNameEnum.WECHAT.getValue())) != -1
                    || s.toString().indexOf(ShopKeyUtils.getSiteUrl(WechatNameEnum.YIAOSHITONG.getValue())) != -1) {
                continue;
            }
